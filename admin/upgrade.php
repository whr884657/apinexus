...
<div class="vs-panel vs-upgrade-panel">
    ...
    <div class="vs-upgrade-actions">
        ...
        <button type="button" class="vs-btn vs-btn--default" id="upgradeMigrateBtn">执行数据库结构更新</button>
    </div>
    ...
    vs_render_notice(
        'warning',
        '更新前请注意',
        '<ul><li>请先完整备份数据库与网站文件</li><li>点击「安装更新」后将弹出二次确认</li><li>「执行数据库结构更新」进入数据库维护弹窗：可选<strong>全量对齐</strong>（只补表结构、不改业务数据）或<strong>版本升级</strong>（按版本跑未完成脚本，可能含配置/数据）；均有二次确认</li><li>建议在业务低峰期执行更新</li></ul>',
