...
function vs_render_content_row(array $item, $announcement = true)
{
    ...
    <div class="vs-api-item vs-content-item" data-content-row="<?php echo $id; ?>"
        ...
        <div class="vs-content-item__main">
            ...
            <div class="vs-content-item__meta">
                ...
                <?php if (!$announcement): ?>
                    ...
                    <?php if (!empty($item['coverlayout_label'])): ?>
                        <span><?php echo vs_e($item['coverlayout_label']); ?></span>
                    <?php endif; ?>
                <?php endif; ?>
                <span><?php echo vs_e($item['createtime']); ?></span>
            </div>
        </div>
        <div class="vs-api-item__actions vs-content-item__actions">
