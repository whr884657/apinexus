...
function vs_render_content_desktop_row(array $ctx, $announcement = true)
{
    ...
    <tr<?php echo $attrs; ?>>
        <td>
            <div class="content-title-cell" data-field="title"><?php echo vs_e($ctx['title']); ?></div>
        </td>
        <?php if ($announcement): ?>
        ...
        <?php else: ?>
            ...
            <td><span class="content-time-cell" data-field="createtime"><?php echo vs_e($ctx['time'] !== '' ? $ctx['time'] : '—'); ?></span></td>
            <td>
                <span class="vs-badge <?php echo (int) $ctx['status'] === ContentManager::STATUS_PUBLISHED ? 'vs-badge--success' : 'vs-badge--default'; ?>" data-field="status_label">
