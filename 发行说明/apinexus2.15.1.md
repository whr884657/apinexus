...
- ZIP：https://gitee.com/xunjinlu/apinexus/releases/download/v2.15.1/apinexus2.15.1.zip
- 标签：`v2.15.1`
...
3. **开发规范**  
   新增 `开发规范/数据库开发规范.md`（本地维护；原「数据库命名规范」已并入）：表名能短则短，避免 `api_` 等冗余前缀；**所有表、所有字段须带详细 COMMENT**。
...
| `开发规范/数据库开发规范.md` | 命名 + 全字段 COMMENT（本地维护） |
