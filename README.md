...
<p align="center">
  <img src="https://img.shields.io/badge/version-10.16.0-blue?logo=semver&logoColor=white" alt="version">
...
- 控制台实时刷新对齐设置间隔；IP 归属地可配置 API；免责声明与友链开关；前台 Redis 缓存扩展；默认主题接口随机排序
...
- AI 生成可视化（横幅+终端进程）；模型列表点选；详情详细文档半折叠毛玻璃预览
