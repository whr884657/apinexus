...
<p align="center">
  <img src="https://img.shields.io/badge/version-13.16.1-blue?logo=semver&logoColor=white" alt="version">
...
- **控制台服务器监控（v13.16.0）**：对接宝塔 / 1Panel；站点三名称（系统 / 浏览器标题 / 顶栏）与自定义页脚版权；文章编辑网格与 Markdown 安全 HTML
...
- 修复宝塔服务器监控导致控制台整页空白；1Panel 双鉴权；设置板块文案对齐（E188）
