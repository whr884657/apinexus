...
<p align="center">
  <img src="https://img.shields.io/badge/version-13.11.0-blue?logo=semver&logoColor=white" alt="version">
...
- 修复示例代码夹杂 `-syn vs-syn--keyword">`：bash 高亮不再拆坏 class；复制走纯文本；aidoc 出入站清洗（E177）
