...
require_once VS_ROOT . '/core/SchemaFullAligner.php';
...
require_once VS_ROOT . '/core/UserDashHello.php';
require_once VS_ROOT . '/core/SiteMedia.php';
...
require_once VS_ROOT . '/core/ApiError.php';
...
require_once VS_ROOT . '/core/SystemApiKey.php';
...
require_once VS_ROOT . '/core/OpenApiBuilder.php';
require_once VS_ROOT . '/core/FrontendStats.php';
require_once VS_ROOT . '/core/GeoCityCoords.php';
require_once VS_ROOT . '/core/DashboardStats.php';
require_once VS_ROOT . '/core/PanelMonitor.php';
...
require_once VS_ROOT . '/core/CardKeyManager.php';
