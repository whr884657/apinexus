...
<section class="uc-dash" id="ucDashboard" data-theme="muming" data-chart-boot="<?php echo $bootAttr; ?>"<?php echo $helloSlot !== '' ? ' data-hello-slot="' . vs_e($helloSlot) . '"' : ''; ?>>
