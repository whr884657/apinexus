...
<script src="<?php echo vs_e(ThemeManager::assetUrl('muming', 'assets/js/playground-response.js')); ?>?v=<?php echo vs_e(VS_VERSION); ?>" defer></script>
<script src="<?php echo vs_e(ThemeManager::assetUrl('muming', 'assets/js/pages/detail-quickstart.js')); ?>?v=<?php echo vs_e(VS_VERSION); ?>" defer></script>
<script src="<?php echo vs_e(ThemeManager::assetUrl('muming', 'assets/js/pages/detail.js')); ?>?v=<?php echo vs_e(VS_VERSION); ?>" defer></script>
