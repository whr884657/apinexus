...
<form id="registerForm" method="post" action="" novalidate>
    ...
    <div class="st-auth__field">
        <span class="st-auth__label">注册身份</span>
        <div class="st-reg-role" role="radiogroup" aria-label="注册身份">
            <label class="st-reg-role__option">
                <input type="radio" name="role" value="user" checked <?php echo $mailEnabled ? '' : 'disabled'; ?>>
                <span class="st-reg-role__card">
                    <strong>普通用户</strong>
                    <span class="st-reg-role__desc">可生成密钥，调用平台全部公开接口。</span>
                </span>
            </label>
            <label class="st-reg-role__option">
                ...
                <span class="st-reg-role__card">
                    <strong>开发者</strong>
                    <span class="st-reg-role__desc">可发布自己的接口，为平台提供技能与支持。</span>
                </span>
            </label>
        </div>
    </div>
