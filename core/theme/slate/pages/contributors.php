...
<section class="st-section">
    ...
    <?php if (count($contributors) === 0): ?>
        <p class="st-notice-box st-notice-box--center">暂无公开贡献者，欢迎注册成为开发者并发布接口。</p>
    <?php else: ?>
    <div class="st-grid-3">
        <?php foreach ($contributors as $c): ?>
            <a class="st-card st-contrib st-contrib--link" href="<?php echo vs_e($c['profile_url']); ?>">
                ...
                <div class="st-contrib__avatar st-is-hidden"><?php echo vs_e($c['letter']); ?></div>
    ...
    <p class="st-notice-box st-notice-box--center st-contrib-cta">
