    ...
    <div class="th5-hero-console reveal reveal-delay-1" aria-label="API 控制台示例">
      ...
      <div class="th5-hero-console__body">
        <div class="th5-hero-console__code" aria-hidden="true">
          <div class="th5-hero-console__line"><span class="c-prompt">$</span> <span class="c-kw">curl</span> https://api.example.com/v1/weather/now</div>
          <div class="th5-hero-console__line">  -H <span class="c-str">"Authorization: Bearer sk-••••••"</span></div>
          <div class="th5-hero-console__line">  -d <span class="c-str">'{"city":"宁波"}'</span></div>
        ...
        <div class="th5-hero-console__row">
          ...
          <span class="th5-hero-console__row-path">/v1/weather/now</span>
          <span class="th5-hero-console__row-status">200</span>
        </div>
        <div class="th5-hero-console__row">
          <span class="th5-hero-console__row-method">POST</span>
          <span class="th5-hero-console__row-path">/v1/ocr/recognize</span>
          <span class="th5-hero-console__row-status">200</span>
        </div>
        <div class="th5-hero-console__row">
          <span class="th5-hero-console__row-method">GET</span>
          <span class="th5-hero-console__row-path">/v1/ip/locate</span>
          <span class="th5-hero-console__row-status">200</span>
        </div>
        <div class="th5-hero-console__foot">
          <span class="th5-hero-console__live">LIVE</span>
          <span class="th5-hero-console__meta font-mono">过去 24h · <?php echo vs_e($todayCallsLabel); ?> 次请求</span>
        </div>
      </div>
    </div>
  </div>
...
<?php if ($showAnnounce): ?>
<script src="<?php echo vs_e(ThemeManager::assetUrl('fifth', 'assets/js/pages/home-announcement.js')); ?>?v=<?php echo vs_e(VS_VERSION); ?>" defer></script>
<?php endif; ?>
